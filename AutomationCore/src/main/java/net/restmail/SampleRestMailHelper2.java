...
import com.auto.core.helpers.WbDriverManager;

public class SampleRestMailHelper2 {
	 ...
	 *                 both are acceptable
	 */
	public SampleRestMailHelper2(String userName) {
	 ...
	 */
	public SampleRestMailHelper2 deleteAllRestMail() {
	...
	public WebElement getVerificationMessage() {
		...
		try {
			WbDriverManager.getDriver().waits().until(
					ExpectedConditions.presenceOfAllElementsLocatedBy(By.xpath(xpathLocator)));
	 ...
	 * @return
	 */
	public boolean confirmChangeEmail(SampleRestMailHelper2 newEmail) {
