...
public class EbnRestMailHelper {
	 ...
	 *                 both are acceptable
	 */
	public EbnRestMailHelper(String userName) {
	 ...
	 */
	public EbnRestMailHelper deleteAllRestMail() {
	 ...
	 * @return
	 */
	public boolean confirmChangeEmail(EbnRestMailHelper newEmail) {
