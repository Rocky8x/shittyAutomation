...
public class SampleRestMailHelper1 {
	 ...
	 *                 both are acceptable
	 */
	public SampleRestMailHelper1(String userName) {
	 ...
	 */
	public SampleRestMailHelper1 deleteAllRestMail() {
	 ...
	 * @return
	 */
	public boolean confirmChangeEmail(SampleRestMailHelper1 newEmail) {
