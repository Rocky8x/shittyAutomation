...
public class PopupNotification {
	public static Element getCloseButton() {
	...
	public static Element getViewButton() {
	...
	public static Element getPopupMessageLabel() {
	...
	public static Element getPopUpHeaderLabel() {
