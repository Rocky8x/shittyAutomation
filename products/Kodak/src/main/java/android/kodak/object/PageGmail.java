...
public class PageGmail extends PageBase{
	...
	public static Element getSendEmailButton() {
	...
	public static Element getContentEmailView() {
	...
	public static Element getTitleEmail() {
	...
	public static Element getAttachmentGrid() {
	 ...
	 * @param subj
	 */
	public static void sendEmail(String email, String subj) {
	...
	public static String getContentEmail() {
		return getContentEmailView().getText();
	}

	public static List<String> getAttachmentsFile(){
		...
		for(WebElement ele : getAttachmentGrid().findElements(By.xpath(attName))) {
			Log.info("Attachment before send: " + ele.getText());
