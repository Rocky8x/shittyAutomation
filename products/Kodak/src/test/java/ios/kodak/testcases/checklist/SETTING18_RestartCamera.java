...
public class SETTING18_RestartCamera extends TestBaseIOS{
	...
	@Test(priority = 99, description = "Verify that user can remove camera")
	public void RestartCamera() throws SerialPortException {
		String camLog;
		...
		PageDeviceSettings.restartDevice();
